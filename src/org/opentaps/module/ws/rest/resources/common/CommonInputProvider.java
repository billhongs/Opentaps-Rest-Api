 ...
 */
public class CommonInputProvider implements InputProviderInterface {
     ...
     */
    public CommonInputProvider(GenericValue userLogin, LocalDispatcher dispatcher) throws InfrastructureException {
